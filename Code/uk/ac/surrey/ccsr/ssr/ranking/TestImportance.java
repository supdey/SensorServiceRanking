...
public class TestImportance {
    ...
    public static void main(String args[]) throws Exception {
        ...
        String folderName = "data/conf-importance/";
        ...
        try {
            ...
            ArrayList<ComputedServiceUsingImportance> services = new ArrayList<ComputedServiceUsingImportance>();
            ...
            while ((aQuery = br.readLine()) != null) {
                ...
                if (al != null && al.size() > 0) {
                    ...
                    for (int k = 0; k < al.size(); k++) {
                        ...
                        ComputedServiceUsingImportance cs = new ComputedServiceUsingImportance();
                    ...
                    ComputedServiceUsingImportance serviceChosen = findServiceWithMinIm(services);
                    queryCount++;
    ...
    private static ComputedServiceUsingImportance findServiceWithMinIm(ArrayList list) {
        System.out.println("LENGTH IS " + list.size());
        System.out.println(list);
        ComputedServiceUsingImportance cs = (ComputedServiceUsingImportance) list.get(0);
        if (list.size() == 1) {
            return cs;
        } else {
            for (int i = 1; i < list.size(); i++) {
                if (cs.compareTo(((ComputedServiceUsingImportance) list.get(i))) > 0) {
                    cs = (ComputedServiceUsingImportance) list.get(i);
                }
            }
            return cs;
        }
...
class ComputedServiceUsingImportance extends ComputedService implements Comparable {

    public ComputedServiceUsingImportance() {
        super();
    }

    public int compareTo(Object o) {
        if (this.getImportance() < ((ComputedServiceUsingImportance) o).getImportance()) {
            return -1;
        } else {
            return 1;
        }
