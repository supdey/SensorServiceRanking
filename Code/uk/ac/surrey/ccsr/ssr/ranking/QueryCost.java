...
public class QueryCost {
    ...
    public static void main(String args[]) {
        ...
        String folderName = "data/configuration20/";
        File report = new File(folderName + "report.txt");
        PrintWriter pw = null;
        ...
        try {
            ...
            while ((aQuery = br.readLine()) != null) {
                ...
                for (int i = 0; i < al.size(); i++) {
                    ...
                    pw.append("IMPORTANCE: " + df.format(importance[cs.getSensorNodeID()]*100) + "\n");

                    //get the power of the sensor node
                    pw.append("ENERGY: " + power[cs.getSensorNodeID()] + "\n");
